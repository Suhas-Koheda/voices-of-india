...
export default function HomePage() {
  ...
  const featured = regions.slice(0, 4);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 md:pt-24 md:pb-28">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-5 text-lg sm:text-xl text-stone-500 leading-relaxed max-w-2xl mx-auto">
              Discover how people speak, sing, and express themselves across
              India&apos;s regions. Through place, sound, and everyday speech.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="mt-2 text-stone-500">
              Start your journey with these diverse languages
            </p>
          </div>
      ...
      <section className="py-16 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="mt-2 text-stone-500">
              Three steps to discover India&apos;s voices
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-stone-500">
                Click any highlighted state on the interactive map of India.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-stone-500">
                Hear phrases, expressions, and folk songs from each region.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-stone-500">
                Explore cultural notes, traditions, and local expressions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-stone-500 mb-8 max-w-xl mx-auto">
            Choose a region and start exploring languages, expressions, and
