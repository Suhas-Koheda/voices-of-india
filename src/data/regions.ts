...
export const regions: Region[] = [
  {
    ...
    name: "Telangana",
    slug: "telangana",
    tagline: "Deccani Telugu — Hyderabadi spice, Warangal heritage, Karimnagar warmth",
    description:
      "Telangana is a land of dialects within dialects. Hyderabad speaks a Hyderabadi Telugu laced with Urdu. Warangal carries the accent of the Kakatiya heartland. Karimnagar and Jagityal have their own distinctive speech patterns. Every 50 kilometres, the language shifts.",
    language: "Telugu",
    languageFamily: "Dravidian",
    capital: "Hyderabad",
    cities: [
      { name: "Hyderabad", description: "City of pearls and biryani, where Telugu meets Urdu on every street" },
      { name: "Warangal", description: "Kakatiya capital — Thousand Pillar Temple and a distinct eastern Telugu accent" },
      { name: "Karimnagar", description: "Steel city of Telangana, known for its warm dialect and Silver Filigree" },
      { name: "Jagityal", description: "Palace town with a unique Telugu dialect different from even neighbouring Karimnagar" },
      { name: "Nizamabad", description: "Fort town on the Godavari, known for turmeric and its own speech rhythm" },
      { name: "Khammam", description: "Gateway to the south, where Telugu blends with Andhra influences" },
    ],
    subRegions: [
      {
        name: "Hyderabad & Rangareddy",
        description: "The cosmopolitan heart where Telugu, Urdu, and Hindi mix freely",
        dialect: "Hyderabadi Telugu — heavy Urdu loanwords, distinctive 'andi/babu' address system",
        localPhrase: "Khamma Ghanta!",
        localPhraseMeaning: "A Hyderabadi greeting meaning 'How are things!'",
      },
      {
        name: "Warangal",
        description: "The Kakatiya heartland with a more traditional Telugu accent",
        dialect: "Eastern Telangana Telugu — closer to standard Telugu, less Urdu influence",
        localPhrase: "Bagunnara abba?",
        localPhraseMeaning: "Are you well? (Warangal style with 'abba' particle)",
      },
      {
        name: "Karimnagar",
        description: "Known for its own distinctive accent — people here speak with a characteristic warmth",
        dialect: "Northern Telangana Telugu — distinct intonation, unique vocabulary",
        localPhrase: "Em chesthunnav ra?",
        localPhraseMeaning: "What are you doing? (Karimnagar casual style)",
      },
      {
        name: "Jagityal",
        description: "Even within Karimnagar district, Jagityal has its own speech pattern",
        dialect: "Jagityal Telugu — subtle differences in pronunciation and word choice from Karimnagar town",
        localPhrase: "Ela unnav ji?",
        localPhraseMeaning: "How are you? (Jagityal polite form)",
      },
      {
        name: "Nizamabad & Adilabad",
        description: "Northern Telangana bordering Maharashtra and Karnataka",
        dialect: "Northern Telangana — Marathi and Kannada loanwords creep in",
        localPhrase: "Horath banthi ji",
        localPhraseMeaning: "It's gotten late (Nizamabad style)",
      },
    ],
    geography:
      "The Deccan plateau, semi-arid with red and black soil. The Godavari and Krishna rivers cut through rocky terrain. The north is hilly with forests, the south is flatter and drier.",
    history:
      "The Kakatiya dynasty built Warangal into a powerhouse in the 12th century. The Qutb Shahis founded Hyderabad in 1591. The Nizams ruled for centuries, creating one of the world's richest courts. Telangana's separate identity movement lasted decades before statehood in 2014.",
    food: [
      { name: "Hyderabadi Biryani", description: "Kachchi dum biryani — raw marinated meat layered with rice and slow-cooked" },
      { name: "Sarva Pindi", description: "Savoury rice flour pancake with peanuts and lentils — a Telangana farmhouse staple" },
      { name: "Pachi Pulusu", description: "Raw tamarind soup — Telangana's summer cooler, nothing like it anywhere else" },
      { name: "Golichina Mamsam", description: "Spicy dry-fried mutton — the real Telangana non-veg, not Hyderabad restaurant food" },
      { name: "Halim", description: "Slow-cooked wheat and meat stew during Ramadan — Hyderabad's pride" },
    ],
    landmarks: [
      { name: "Charminar", description: "Four-minareted mosque built in 1591 — the soul of old Hyderabad" },
      { name: "Golconda Fort", description: "Acoustic marvel where a clap at the entrance can be heard at the top — diamonds were mined here" },
      { name: "Thousand Pillar Temple, Warangal", description: "Kakatiya-era temple with 1000 intricately carved stone pillars" },
      { name: "Ramappa Lake", description: "UNESCO-listed Ramappa Temple sits beside this ancient lake" },
      { name: "Ramoji Film City", description: "The world's largest film studio complex — a city within a city" },
    ],
    traditions:
      "Bonalu festival honouring Goddess Mahakati with processions and colourful offerings. Bathukamma — women create stunning flower arrangements and dance around them. Deccani Urdu mushairas. Irani chai culture. Pearl shopping in the old city around Charminar.",
    phrases: [
      { id: "ts-1", text: "Khamma Ghanta!", meaning: "How are things! (Hyderabadi greeting)", transliteration: "Khamma Ghanta" },
      { id: "ts-2", text: "Bagunnava ra?", meaning: "Are you good? (casual)", transliteration: "Bagunnava ra" },
      { id: "ts-3", text: "Naku artham kaledu", meaning: "I don't understand", transliteration: "Naku artham kaledu" },
      { id: "ts-4", text: "Chala bagundi", meaning: "It's very good", transliteration: "Chala bagundi" },
      { id: "ts-5", text: "Meeku em kavali?", meaning: "What do you need?", transliteration: "Meeku em kavali" },
    ],
    expressions: [
      { id: "ts-expr-1", text: "Abba!", meaning: "Oh! (mild surprise)", context: "Used at end of sentences for emphasis" },
      { id: "ts-expr-2", text: "Andi!", meaning: "Respectful address — like 'sir/madam'", context: "Hyderabadi politeness marker" },
      { id: "ts-expr-3", text: "Khair!", meaning: "OK! / Alright!", context: "Hyderabadi acceptance, from Urdu" },
    ],
    songs: [
      { id: "ts-song-1", title: "Bonalu Songs", description: "Devotional songs during Bonalu festival with Dappu drums and langa veni dance." },
      { id: "ts-song-2", title: "Bathukamma Songs", description: "Women's folk songs sung during the flower festival — rhythmically unique to Telangana." },
    ],
